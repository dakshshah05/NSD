...
// ...
  ...
  const generateCSV = async (type) => {
    ...
    try {
      ...
      if (!csvContent) throw new Error("No data available");
      ...
      if (settings.emailReports) {
          addNotification('Report Ready', `Opening your email client to send ${filename}...`);
          
          // Construct mailto link
          const subject = encodeURIComponent(`EnergyGuard Report: ${filename}`);
          const body = encodeURIComponent(`Please find the attached report data for ${selectedDate}.\n\n[Attach ${filename} here]\n\nGenerated by EnergyGuard Dashboard.`);
          
          // Trigger email client
          window.location.href = `mailto:dakshshah215@gmail.com?subject=${subject}&body=${body}`;
          
          console.log(`[Email Service]: Triggered mailto for ${filename}`);
      } else {
