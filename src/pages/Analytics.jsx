      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[rgb(var(--bg-card))] border border-[rgb(var(--border))] rounded-2xl p-6 shadow-lg lg:col-span-1 min-h-[400px] overflow-hidden">
          ...
          <div className="overflow-x-auto md:overflow-x-hidden scrollbar-hide">
            <div className="h-72 min-w-[320px] md:min-w-0 relative mx-auto">
        ...
        <div className="bg-[rgb(var(--bg-card))] border border-[rgb(var(--border))] rounded-2xl p-4 md:p-6 shadow-lg lg:col-span-2 overflow-hidden">
           <div className="flex justify-between items-start mb-2">
            ...
            <div className="overflow-x-auto md:overflow-x-hidden scrollbar-hide pb-2">
                 ...
                 <ResponsiveContainer width="100%" height="100%">
                   <ComposedChart 
                    ...
                    >
                     ...
                     <Bar yAxisId="left" dataKey="occupancy" barSize={20} fill="#3b82f6" radius={[4, 4, 0, 0]} name="People" />
